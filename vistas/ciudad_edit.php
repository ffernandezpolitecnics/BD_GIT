<?php 
    ...
    {
        $resultado = selectCiudadById($_POST['id_ciudad']);
        $ciudad = $resultado[0];
    }
?>
                ...
                <form action="../controllers/ciudadController.php" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control form-control-sm" name="id_ciudad" id="inputIdCiudad"
                             ...
                             value="<?php echo $ciudad['id_ciudad'] ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10 offset-2">
                            <button type="submit" name="modificar" class="btn btn-primary btn-sm col-boton">ACEPTAR</button>
